...
import { Anniversary } from "./collections/Anniversary";
...
export default buildConfig({
  ...
  collections: [Users, Media, Catagory, Menu, Testimonal, Reservation, FloorPlan, TableLayout, PanoramaView, Anniversary],
